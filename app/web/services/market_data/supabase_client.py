...
from app.web.core.exceptions import DatabaseConnectionError
...
class SupabaseConnection:
    ...
    def __init__(self, settings: Settings, max_retries: int = 3, base_delay_seconds: float = 0.75):
        ...
        self._logger = get_logger("app.web.services.market_data.supabase_client")
    ...
    def execute_with_retry(self, operation: Callable[[], T], operation_name: str) -> T:
        ...
        raise DatabaseConnectionError(
            ...
            f"{self._max_retries} attempts. Errors: {errors}"
        )
