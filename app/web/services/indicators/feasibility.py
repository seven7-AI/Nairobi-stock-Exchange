...
from app.web.services.indicators.registry import IndicatorDefinition
...
INDICATOR_REQUIREMENTS: dict[str, dict[str, Any]] = {
    ...
    "Dividend Yield": {
        "fields": {"dividends_metrics.dividendYield"},
        "source": "stockanalysis_stocks",
    },
...
def analyze_feasibility(indicators: list[IndicatorDefinition]) -> list[FeasibilityRecord]:
    ...
    for indicator in indicators:
        ...
        if req is None:
            # Unmapped indicators generally need financial-statement fields that are
